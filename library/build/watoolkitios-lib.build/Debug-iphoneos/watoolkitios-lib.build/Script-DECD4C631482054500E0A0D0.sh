...
#########
#
# Added: Copy Include Files
#
if [ -d "${CURRENTCONFIG_DEVICE_DIR}/watoolkitios-lib" ]
then
mkdir -p "${CREATING_UNIVERSAL_DIR}/watoolkitios-lib"
# * needs to be outside the double quotes?
cp "${CURRENTCONFIG_DEVICE_DIR}/watoolkitios-lib/"* "${CREATING_UNIVERSAL_DIR}/watoolkitios-lib"
fi
fi
